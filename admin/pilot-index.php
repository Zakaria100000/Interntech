        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $count_pages = "SELECT * FROM user WHERE id_role = 2";
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT u.id as id, u.firstname as firstname, u.lastname as lastname, u.email as email, u.password as password, r.name as role, c.name as center, p.name as promo 
                            ...
                            LIKE '%$search%' AND u.id_role = 2
                            ORDER BY $order $sort
                            LIMIT $offset, $no_of_records_per_page";
                        $count_pages = "SELECT * FROM user
                            WHERE CONCAT_WS (id,firstname,lastname,email,password,id_role,id_center,id_promo) AND id_role = 2
                            LIKE '%$search%'
                            ORDER BY $order $sort";
                    }
                    else {
