...
if(isset($_POST["id_permission"]) && !empty($_POST["id_permission"])){
    ...
    $sql = "DELETE FROM role_permission WHERE id_permission = ?";

    if($stmt = mysqli_prepare($link, $sql)){
        // Set parameters
        $param_id = trim($_POST["id_permission"]);
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <div class="alert alert-danger fade-in">
                            <input type="hidden" name="id_permission" value="<?php echo trim($_GET["id_permission"]); ?>"/>
