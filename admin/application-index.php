            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Applications Details</h2>
                        <a href="application-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="application-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                        <a href="index.php" class="btn btn-secondary float-right mr-2">Back</a>
                    </div>

                    <div class="form-row">
                        <form action="application-index.php" method="get">
                        <div class="col">
                    ...
                    $orderBy = array('id', 'cv', 'lm', 'id_user', 'id_Internship', 'id_status');
                    $order = 'id';
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
										...
										echo "<th><a href=?search=$search&sort=&order=cv&sort=$sort>CV</th>";
										echo "<th><a href=?search=$search&sort=&order=lm&sort=$sort>Motivation Letter</th>";
										echo "<th><a href=?search=$search&sort=&order=id_user&sort=$sort>User</th>";
										echo "<th><a href=?search=$search&sort=&order=id_Internship&sort=$sort>Internship</th>";
										echo "<th><a href=?search=$search&sort=&order=id_status&sort=$sort>Status</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['id'] . "</td>";echo "<td>" . $row['cv'] . "</td>";echo "<td>" . $row['lm'] . "</td>";echo "<td>" . $row['id_user'] . "</td>";echo "<td>" . $row['id_Internship'] . "</td>";echo "<td>" . $row['id_status'] . "</td>";
                                        echo "<td>";
                                            ...
                                            echo "<a href='application-delete.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
