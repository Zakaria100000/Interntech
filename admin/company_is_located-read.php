...
if(isset($_GET["id_location"]) && !empty($_GET["id_location"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        // Set parameters
        $param_id = trim($_GET["id_location"]);
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <h4>Location</h4>
                            <p class="form-control-static"><?php echo $row["id_location"]; ?></p>
                        </div>

                    <p><a href="company_is_located-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
