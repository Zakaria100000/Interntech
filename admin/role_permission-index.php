        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $orderBy = array('id_role', 'id_permission', 'is_allowed');
                    $order = 'id_permission';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "<td>" . $row['permission'] . "</td>";echo "<td>" . $row['is_allowed'] . "</td>";
                                        echo "<td>";
                                            ...
                                            echo "<a href='role_permission-delete.php?id_permission=". $row['id_permission'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
