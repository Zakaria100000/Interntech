...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $stmt = $pdo->prepare("UPDATE location SET id=?,city=? WHERE id=?");

    if(!$stmt->execute([ $id,$city,$id  ])) {
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
						...
						<div class="form-group">
                                <label>City</label>
                                <input type="text" name="city" maxlength="50"class="form-control" value="<?php echo $city; ?>">
