            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    echo "<div class='page-header clearfix'>";
                        echo "<h2 class='float-left'>Delegates Details</h2>";
                        if ($_SESSION['SFx18'] == 1) {
                            echo "<a href='delegate-create.php' class='btn btn-success float-right'>Add New Delegate</a>";
                        }
                        echo "<a href='delegate-index.php' class='btn btn-info float-right mr-2'>Reset View</a>";
